                ...
                <ScrollView keyboardShouldPersistTaps={'handled'}>
                    <View style={styles.checkoutProcess}>
                        ...
                        <View style={styles.yourCartSection}>
                            ...
                            <View style={styles.checkoutCartItem}>
                                ...
                                <View style={styles.items}>
                                    <Text style={styles.totalItems}>89 items</Text>
                                </View>
                            </View>
                            {/*Product Cost*/}
                            <View style={styles.checkoutProductCost}>
                                ...
                                <View style={styles.productPrice}>
                                    <Text style={styles.productPriceTitle}>৳ 70</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.deliveryChargeContent}>
                                ...
                                <View style={styles.deliveryPrice}>
                                    <Text style={styles.deliveryPriceTitle}>৳ 90</Text>
                                </View>
                            </View>
                            {/*Total Cost*/}
                            <View style={styles.totalCostContent}>
                                ...
                                <View style={styles.totalPrice}>
                                    <Text style={styles.totalPriceTitle}>৳ 90</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={{flexDirection: "row", marginBottom: 10}}>
                            ...
                            <View style={{flex: 1, margin: 4}}>
                                <TouchableOpacity>
                                    <View style={styles.insideDhakaButton}>
                                        <View style={{flexDirection: "row"}}>
                                            <View style={{flex: 1}}>
                                                <Text>
                                                    <FontAwesome name="check-circle-o" size={20} color="green"/>
